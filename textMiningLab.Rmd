...
# Analysis of Northeast and Midwest Regions (Adam)
...
#Making a function for afinn histograms
histo_afinn = function(x) {
  ggplot(data = x,
       aes(x=value)) +
       geom_histogram()+
       ggtitle('Histogram of Afinn values') +
       theme_minimal()
}
...
S_FullAfinnC = viz_afinn(S_FullAfinn)
...
W_FullAfinnC = viz_afinn(W_FullAfinn)

# make ggplot to plot counts of afinn positivity values
S_hist_afinn = lapply(South_afinn, histo_afinn)
W_hist_afinn = lapply(West_afinn, histo_afinn)
...
## Analysis of South and West Regions (Declan)
